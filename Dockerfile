...
RUN coverlet /opt/blogifier/tests/Blogifier.Tests/bin/Release/net5.0/Blogifier.Tests.dll --target "dotnet" --targetargs "test -c Release --no-build" --format opencover
